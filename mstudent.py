...
def get_student(stud_number,cursor):
    '''
    gets students infos in a tuple containing first and last name of the student , the gender and his email addresses

    '''

    query="SELECT * FROM Student WHERE stud_number= ?"
    value=(stud_number,)
    ...
    try:
        ...
        return None
    for element in res:
        email_addresses.append(element)
